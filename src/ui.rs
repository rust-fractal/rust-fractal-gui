...
pub fn window_main(renderer: Arc<Mutex<FractalRenderer>>) -> impl Widget<FractalData> {
    ...
    let group_palette = Flex::column()
        ...
        .with_spacer(4.0)
        .with_child(Flex::row()
            .with_child(Label::new("Stripe Scale:").fix_width(100.0))
            .with_flex_child(Slider::new()
                .with_range(0.1, 10.0)
                .expand_width()
                .lens(FractalData::stripe_scale.map(|val| *val as f64, |new, val| *new = 0.1 * (val * 10.0).round() as f32)), 1.0)
            .with_child(Label::<f32>::new(|data: &f32, _env: &_| {
                format!("{:>2.1}", *data)
            }).lens(FractalData::stripe_scale)))
        .with_spacer(4.0)
        .with_child(create_label_textbox_row("Transition:", 160.0)
        ...
        .with_spacer(4.0)
        .with_child(Flex::row()
            .with_child(Label::new("Opacity:").fix_width(100.0))
            .with_flex_child(Slider::new()
                .with_range(0.0, 1.0)
                .expand_width()
        ...
        .with_spacer(4.0)
        .with_child(Flex::row()
            .with_child(Label::new("Ambient:").fix_width(100.0))
            .with_flex_child(Slider::new()
                .with_range(0.0, 1.0)
                .expand_width()
        ...
        .with_spacer(4.0)
        .with_child(Flex::row()
            .with_child(Label::new("Diffuse:").fix_width(100.0))
            .with_flex_child(Slider::new()
                .with_range(0.0, 1.0)
                .expand_width()
        ...
        .with_spacer(4.0)
        .with_child(Flex::row()
            .with_child(Label::new("Specular:").fix_width(100.0))
            .with_flex_child(Slider::new()
                .with_range(0.0, 1.0)
                .expand_width()
    ...
    let _group_pixel_information = Flex::column()
        .with_child(Flex::row()
